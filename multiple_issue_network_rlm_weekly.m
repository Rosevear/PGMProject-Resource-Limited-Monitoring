...
for iteration = 1:NUM_ITERATIONS
    ...
    %Connect all decisions to the rlm_utility node
    for i = 1:5
        dag(test_d, 51) = 1;
        dag(test2_d, 51) = 1;
        dag(treat_d(i), 51) = 1;
    ...
    params(rlm_utility) = rlm_utility_params;

    %Make the influence diagram
    limid = mk_limid(dag, ns, 'chance', [S_obs S_true S2_obs S2_true], 'decision', [test_d treat_d test2_d treat2_d], 'utility', [utility rlm_utility], 'equiv_class', params);
